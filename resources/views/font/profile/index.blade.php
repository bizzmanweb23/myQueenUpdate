                    ...
                    <div class="card-body">
                        <div class="row">
                                            ...
                                            <div class="mt-3"
                                                ...
                                                <h4>{{ Auth::user()->name }}</h4>
												 <?php 
													...
													{?>
                                                <p class="text-secondary mb-1 text-bold">@lang('order.Balance'):
                                                    <?php echo $data->wallet; ?></p>
												<?php
													}
												?>
                                                <?php 
													foreach($result as $data)
													{?>
                                                <p class="text-bold mb-1">@lang('order.Total Revenue'): <?php echo $data->bonusSum; ?></p>
                                                <?php
													}
												?>
												<?php 
													foreach($result as $data)
													{?>
                                                <p class="text-bold mb-1">@lang('order.Points'): <?php echo $data->total_pv_point; ?> @lang('order.PV')
                                                </p>
												<?php
													}
												?>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-sm-3">
                                        <h6 class="mb-3">@lang('order.Unique Id')</h6>
                                    </div>
                                    <div class="col-sm-9 ">
                                        {{ Auth::user()->user_id }}
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-3">
                                        <h6 class="mb-3">@lang('order.Full Name')</h6>
                                    </div>
                                    <div class="col-sm-9 ">
                                        {{ Auth::user()->name }}
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-3">
                                        <h6 class="mb-3">@lang('user.Email')</h6>
                                    </div>
                                    <div class="col-sm-9 ">
									    <?php 
											 foreach($result as $data)
                                ...
                                <div class="row">
                                    <div class="col-sm-3">
                                        <h6 class="mb-3">@lang('order.Phone')</h6>
                                    </div>
                                    <div class="col-sm-9 ">
                                        <?php 
											 foreach($result as $data)
                                ...
                                <div class="row">
                                    <div class="col-sm-3">
                                        <h6 class="mb-3">@lang('order.Join')</h6>
                                    </div>
                                    <div class="col-sm-9 ">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">@lang('order.Edit Profile')</h5>
                ...
                <div class="modal-body">
                    <form id="edit_profile_form">
                        ...
                        <div class="form-group">
                            <label for="">@lang('user.name'):</label>
                            <input type="text" name="name" id="name" class="form-control"
                                value="{{ Auth::user()->name }}">
                            <span style="color: red" id="edit_name_error"></span>
                        </div>
                        <div class="form-group">
                            <label for="">@lang('user.email'):</label>
                            <input type="text" name="email" id="email" class="form-control"
                                value="<?php foreach ($result as $data){ echo $data->email_id;}?>">
                            <span style="color: red" id="edit_email_error"></span>
                        </div>
                        <div class="form-group">
                            <label for="">@lang('order.Phone'):</label>
                            <input type="text" name="phone" id="phone" class="form-control"
                                value="<?php foreach ($result as $data){ echo $data->mobile_no;}?>">
                            <span style="color: red" id="edit_phone_error"></span>
                        </div>
                        <div class="form-group">
                            <label for="">@lang('order.Upload Profile Image'):</label>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal" style="padding: 8px">@lang('order.Close')</button>
                    <button type="button" class="btn btn-primary" style="padding: 8px" id="save_edit_form_btn">@lang('order.Save changes')</button>
                </div>
            </div>
        </div>
    </div>
