    ...
    <main class="main">
        <nav class="breadcrumb-nav">
            <div class="container">
                <ul class="breadcrumb" style="background: none;">
                    ...
                    <li>@lang('auth.account')</li>
                </ul>
            </div>
        </nav>
        <div class="page-header pl-4 pr-4" style="background-image: url({{ asset('asset/image/font/about-us.jpg') }})">

            <h1 class="page-title font-weight-bold lh-1 text-capitalize">@lang('order.pointwallet')</h1>
        ...
        <div class="container">
            <div class="point-wallet">
                ...
                <p>@lang('order.You have') {{ Auth::user()->total_pv_point }} @lang('order.pvpoint') </p>
                <ol class="progtrckr" data-progtrckr-steps="5">
                    <li class="{{ $rank_id >= 1 ? 'progtrckr-done' : '' }}">@lang('order.Normal Member')</li>
                    <li class="{{ $rank_id >= 2 ? 'progtrckr-done' : '' }}">@lang('order.Silver Member')</li>
                    <li class="{{ $rank_id >= 3 ? 'progtrckr-done' : '' }}">@lang('order.Gold Member')</li>
                    <li class="{{ $rank_id >= 4 ? 'progtrckr-done' : '' }}">@lang('order.Diamond Member')</li>
                </ol>

            </div>
            <div class="upgrade">
                {{-- <a href="#">@lang('order.upgrade')</a>
                <p class="small-text">@lang('order.upgradequote')</p> --}}
            </div>
                    ...
                    <table class="table loyal-table">
                        <thead>
                            <tr>
                                ...
                                <th scope="col">@lang('order.OrderNumber').</th>
    ...
    <div class="modal credit_bonus" id="myModal2">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <!-- Modal body -->
                <div class="modal-body">
                    <p>@lang('order.You have') <?php foreach($result as $data){ echo '$' . $data->total_pv_point; }?> @lang('order.bonus points')</p>
                    ...
                    <br>
                    <button class="btn btn-primary btn-md" id="redeem_full_points">@lang('order.fullRedeem')</button>
                    <button class="btn btn-dark btn-md" id="redeem_credit_points">@lang('order.Submit')</button>
                </div>
