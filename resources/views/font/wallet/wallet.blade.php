            ...
            <div class="container">
                <div class="aiz-titlebar mt-2 mb-4">
                    <div class="row align-items-center">
                        <div class="col-md-6">
                            <h1 class="h3">@lang('wallet.My Wallet')</h1>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-4 mx-auto mb-3">
                        <div class="bg-grad-1 text-white rounded-lg overflow-hidden">
                            ...
                            <div class="px-3 pt-3 pb-3">
                                <div class="h4 fw-700 text-center"><?php foreach($result as $data) { echo $data->wallet;}?></div>
                                <div class="opacity-50 text-center">@lang('wallet.Wallet Balance')</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 mx-auto mb-3">
                        <div class="p-3 rounded mb-3 c-pointer text-center bg-white shadow-sm hov-shadow-lg has-transition"
                            ...
                            <div class="fs-18 text-primary">@lang('wallet.Recharge Wallet')</div>
                        </div>
                    </div>
                </div>
                <div class="card">
                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <a class="nav-link active" id="wallet-tab" data-toggle="tab" href="#show_wallet_page"
                                    role="tab" aria-controls="wallet" aria-selected="true">@lang('wallet.Wallet History')</a>
                            </li>
                            <li class="nav-item" role="presentation">
                                <a class="nav-link" id="credit-wallet-tab" data-toggle="tab" href="#get_wallet_bonus"
                                    role="tab" aria-controls="creditwallet" aria-selected="false">@lang('wallet.Credit Wallet History')</a>
                            </li>
                            <li class="nav-item" role="presentation">
                                <a class="nav-link" id="Loyality-wallet-tab" data-toggle="tab"
                                    ...
                                    aria-selected="false">@lang('wallet.Loyality wallet History')</a>
                            </li>
                            <li class="nav-item" role="presentation">
                                <a class="nav-link" id="Loyality-wallet-tab" data-toggle="tab"
                                    href="#get_payment_history" role="tab" aria-controls="payment"
                                    aria-selected="false">@lang('wallet.Payment History')</a>
                            </li>
                        </ul>
                                ...
                                <table id="table" data-toggle="table" data-height="460" data-ajax="get_all_payment"
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th data-field="name">@lang('user.Name')</th>
                                            <th data-field="payment_type">@lang('wallet.Payment Type')</th>
                                            <th data-field="amount" data-formatter="amount">@lang('wallet.Amount')</th>
                                            <th data-field="screen_shot" data-formatter="screen_shot">@lang('wallet.Screenshot')</th>
                                            <th data-field="status" data-formatter="status">@lang('wallet.Status')</th>
                            ...
                            <div class="tab-pane" id="get_wallet_bonus" role="tabpanel"
                                ...
                                <table id="table" data-toggle="table" data-height="460" data-ajax="showwalletdetails"
                                    ...
                                    <thead>
                                        <tr>
                                            <th data-checkbox="true"></th>
                                            <th data-field="name">@lang('wallet.User Name')</th>
                                            <th data-field="credit_points" data-formatter="amount">@lang('wallet.Amount')</th>
                                            <th data-field="status" data-formatter="status">@lang('wallet.Status')</th>
                                            <th data-field="redemption_date">@lang('order.Date')</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                    </tbody>
                            ...
                            <div class="tab-pane" id="get_payment_history" role="tabpanel">
                                <table id="table" data-toggle="table" data-height="460" data-ajax="get_payment_history"
                                    ...
                                    <thead>
                                        <tr>
                                            <th data-checkbox="true"></th>
                                            <th data-field="order_unique">@lang('wallet.Order Id')</th>
                                            <th data-field="wallet" data-formatter="amount">@lang('wallet.Amount')</th>
                                            <th data-field="created_at" data-formatter="change_date_format">@lang('order.Date')</th>
                                        </tr>
                                    </thead>
                                    <tbody>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">@lang('wallet.Recharge Wallet')</h5>
                ...
                <form id="wallet_form">
                    ...
                    <div class="modal-body gry-bg px-3 pt-3">
                        <div class="row">
                            <div class="col-md-6">
                                <label>@lang('wallet.Amount') <span class="text-danger">*</span></label>
                                ...
                                <label>@lang('wallet.Payment Screenshot') <span class="text-danger">*</span></label>
                                <input type="file" lang="en" class="form-control mb-3" name="payment_screen_shot">
                            </div>
                            <div class="col-md-6">
                                <label>@lang('order.Payment method') <span class="text-danger">*</span></label>


                                <div>
                                    <input type="checkbox" name="mct_pay" id="mct_pay">
                                    <label for="">@lang('user.MCT Pay')</label>
                                ...
                                <div>
                                    ...
                                    <label for="">@lang('wallet.Pay Now')</label>
                        ...
                        <div class="form-group text-right">
                            <button type="submit" class="btn btn-sm btn-primary transition-3d-hover mr-1"
                                id="user_wallet_btn">@lang('wallet.Confirm')</button>
                        </div>
                    </div>
                </form>
            </div>
