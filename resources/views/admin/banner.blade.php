                        ...
                        <div class="card-body">
                            <table id="example2" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{$key+1}}</td>
                                        <td><img src="{{asset ('Banner/english/'. $banner->Image_eng) }}" alt=""  width="150px" height="100px"></td>
                                        <td><img src="{{asset ('Banner/china/'. $banner->Image_ch) }}" alt=""  width="150px" height="100px"></td>
                                        <td>
                                            <a onclick="return confirm('Are you sure want to delete?')" href="{{route('Delete-Banner',$banner->id)}}"><i class="fas fa-trash-alt"></i></a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" id="add_banner_form" action="{{route('Store-Banner')}}" enctype="multipart/form-data">
                    @csrf
