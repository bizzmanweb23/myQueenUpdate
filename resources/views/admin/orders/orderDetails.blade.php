                    ...
                    <div class="card-body">
                        ...
                        <div class="clearfix float-left">
                            <div class="text-right no-print">
                                @if ($show_pay_btn == 1)
                                    <a href="{{ route('payment.show_details', $payment_id) }}" type="button"
                                        class="btn btn-primary btn-light" target="_blank">Show Payment Details</a>
                                @endif

                                @if ($show_pay_btn == 2)
                                    <a href="{{ route('mct.show', $payment_id) }}" type="button"
                                        class="btn btn-primary btn-light" target="_blank">Show Payment Details</a>
                                @endif
                        ...
                        <div class="clearfix float-right">
                            ...
                            <div class="text-right no-print">
                                <a href="{{ route('invoice.show', $data->order_id) }}" type="button"
...
@section('javascript')
    <script>
        $('#update_payment_status').change(function() {
            var status = $(this).val();
            $.ajax({
                url: "{{ URL::signedRoute('orders.change_status') }}",
                type: 'post',
                data: {
                    status_id: status,
                    order_id: "{{ request()->id }}",
