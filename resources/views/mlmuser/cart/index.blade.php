...
@section('body')
    ...
    <link rel="stylesheet" href="{{ asset('bootstrap-touchspin/jquery.bootstrap-touchspin.css') }}">
                    ...
                    <div class="bs-stepper-header" role="tablist">
                        <div class="step " data-target="#section-1">
                            <button type="button" class="step-trigger" aria-selected="true">
                                ...
                                <span class="bs-stepper-label">
                                    <span class="bs-stepper-title">@lang('user.Cart')</span>
                                    <span class="bs-stepper-subtitle">@lang('user.cartItems')</span>
                                </span>
                            </button>
                        </div>
                        ...
                        <div class="step " data-target="#section-2">
                            <button type="button" class="step-trigger" aria-selected="true">
                                ...
                                <span class="bs-stepper-label">
                                    <span class="bs-stepper-title">@lang('user.Address')</span>
                                    <span class="bs-stepper-subtitle">@lang('user.Enteraddress')</span>
                                </span>
                            </button>
                        </div>
                        ...
                        <div class="step" data-target="#section-3">
                            <button type="button" class="step-trigger" aria-selected="false">
                                ...
                                <span class="bs-stepper-label">
                                    <span class="bs-stepper-title">@lang('user.Payment')</span>
                                    <span class="bs-stepper-subtitle">@lang('user.paymentMethod')</span>
                                </span>
                            </button>
                        </div>
                    ...
                    <div class="bs-stepper-content">
                        ...
                        <form id="main_order_form">
                            ...
                            <div id="section-1" role="tabpanel" class="bs-stepper-pane fade " aria-labelledby="trigger1">
                                @include('mlmuser.cart.cart_item')
                            </div>
                                        ...
                                        <div id="accordionWrapa10" role="tablist" aria-multiselectable="true">
                                            <div class="card collapse-icon">
                                                <div class="card-header">
                                                    <h4 class="card-title">@lang('user.Address')</h4>
                                                </div>
                                                <div class="card-body">
                                                        ...
                                                        <div class="card">
                                                            <div class="card-header" data-toggle="collapse" role="button"
                                                                ...
                                                                <span class="lead collapse-title"
                                                                    style="font-weight: bold;font-size: 17px;"> @lang('user.homeDelivery')
                                                                </span>
                                                            ...
                                                            <div id="accordion10" role="tabpanel"
                                                                ...
                                                                class="collapse">
                                                                <div class="card-body">
                                                                    @include('mlmuser.cart.home_delivery')
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="card">
                                                            <div class="card-header" data-toggle="collapse" role="button"
                                                                ...
                                                                <span class="lead collapse-title"
                                                                    style="font-weight: bold;font-size: 17px;"> @lang('user.SelfPickup')
                                                                </span>
                                                            </div>
                                                            <div id="accordion40" role="tabpanel"
                                                                ...
                                                                <div class="card-body">
                                                                    <div class="row p-2">
                                                                        <div class="row">
                                                                            <label>@lang('user.countryRegion') *</label>
                                                                            <div class="">
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-xs-6">
                                                                                <label>@lang('user.Singapore') *</label>
                                    ...
                                    <div class="col-md-8">
                                        <div class="card">
                                            <div class="card-header flex-column align-items-start">
                                                <h4 class="card-title">@lang('user.Payment options')</h4>
                                                <p class="card-text text-muted mt-25">@lang('user.paymentdesc')
                                                </p>
                                            </div>
                                            <div class="card-body">
                                                <input type="hidden" name="last_main_part" id="last_main_part">
                                                @include('mlmuser.cart.payment_option')
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="card p-2">
                                            <div class="card-header">
                                                <h4 class="card-title">@lang('user.Price Details')</h4>
                                            </div>
											<div id="discount_wallet"></div>
                                            <div class="card-body" id="wallet_charges">
