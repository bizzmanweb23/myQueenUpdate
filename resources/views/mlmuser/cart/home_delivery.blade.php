<div class="row p-2 mb-4">
    <div class="col-md-6 mt-2" style="border-right: 1px solid black;" id="billing_details">
        <h3 class="title title-simple text-left text-uppercase">@lang('user.BillingDetails')</h3>
        <div class="row mb-4">
            <div class="col-xs-6">
        ...
        <div class="row mb-4">
            <div class="col-xs-12">
                <label>@lang('user.StreetAddress') *</label>
                <input type="text" class="form-control" name="address" placeholder="@lang('user.homeAndStreet')"
                    id="address" />
        ...
        <div class="row mb-4">
            <div class="col-xs-6">
                <label>@lang('user.TownCity') *</label>
        ...
        <div class="mb-6 form-checkbox shcheck" style="display: flex;align-items: center">
            ...
            <label class="form-control-label ls-s mt-1 p-2" for="different-address" id="shiptosame">@lang('user.shippingAddress')</label>
        </div>
    </div>

    <div class="col-md-6 mt-2" id="ship_details">
        <h3 class="title title-simple text-left text-uppercase">@lang('user.Shipment Details')</h3>
        <div class="row mb-5">
            <div class="col-xs-6">
                <label>@lang('user.firstName') *</label>
        ...
        <div class="row mb-4">
            <div class="col-xs-12">
                <label>@lang('user.StreetAddress') *</label>
                <input type="text" class="form-control" name="address_ship" placeholder="@lang('user.homeAndStreet')"
                    id="address_ship" />
