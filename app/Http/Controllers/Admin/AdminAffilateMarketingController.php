...
class AdminAffilateMarketingController extends Controller
{
    ...
    public function create()
    {
        ...
        $data = MlmUser::join('rankings','rankings.id','=','mlm_users.rank_id','left')
		                     ->select('mlm_users.id','rankings.details','mlm_users.user_id','mlm_users.sponser_id','mlm_users.member_id','mlm_users.email_id')
							 ->get();
