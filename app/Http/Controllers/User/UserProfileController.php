...
class UserProfileController extends Controller
{
    ...
    {
        $data['result'] = MlmUser::select(DB::raw('total_direct_dponsor+total_matching_bonus+wallet+leadership_bonus as bonusSum'),'wallet','total_pv_point','email_id','mobile_no')
